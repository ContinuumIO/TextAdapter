...
TextAdapter loads NumPy arrays (and Pandas DataFrames) directly from files, SQL
...
TextAdapter provides a drop-in replacement for the 
...
TextAdapter can also be installed into your own (non-Anaconda) Python
environment.  For more information about TextAdapter please contact
