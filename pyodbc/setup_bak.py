...
def main():
    ...
    kwargs = {
        'name': "pyodbc",
        'version': version_str,
        'description': "private fork of pyodbc (a DB API Module for ODBC)",

        'long_description': ('A Python DB API 2 module for ODBC that maps to NumPy types. This project provides an up-to-date, '
                            'convenient interface to ODBC using native data types like datetime and decimal.'),
        
        'maintainer':       "Continuum Analytics, Inc.",
        'maintainer_email': "support@continuum.io",
        
        'ext_modules': [Extension('pyodbc', files, **settings)],

        'license': 'Continuum Analytics Proprietary',
